...
static SInt32  e1000_check_for_serdes_link_82571(struct e1000_hw *hw);
 ...
 **/
SInt32 e1000_get_hw_semaphore_82571(struct e1000_hw *hw)
{
	UInt32 swsm;
	SInt32 ret_val = E1000_SUCCESS;
	SInt32 sw_timeout = hw->nvm.word_size + 1;
	SInt32 fw_timeout = hw->nvm.word_size + 1;
	SInt32 i = 0;
 ...
 *
 **/
SInt32 e1000_check_for_serdes_link_82571(struct e1000_hw *hw)
{
	struct e1000_mac_info *mac = &hw->mac;
	UInt32 rxcw;
	UInt32 ctrl;
