...
static SInt32 e1000_init_phy_params_pchlan(struct e1000_hw *hw);
...
static SInt32  e1000_acquire_nvm_ich8lan(struct e1000_hw *hw);
...
static SInt32  e1000_set_lplu_state_pchlan(struct e1000_hw *hw, bool active);
...
static SInt32  e1000_valid_led_default_ich8lan(struct e1000_hw *hw,
                                            UInt16 *data);
static SInt32 e1000_id_led_init_pchlan(struct e1000_hw *hw);
static SInt32  e1000_get_bus_info_ich8lan(struct e1000_hw *hw);
...
static SInt32  e1000_k1_gig_workaround_hv(struct e1000_hw *hw, bool link);
static SInt32  e1000_setup_led_pchlan(struct e1000_hw *hw);
static SInt32  e1000_cleanup_led_pchlan(struct e1000_hw *hw);
static SInt32  e1000_led_on_pchlan(struct e1000_hw *hw);
static SInt32  e1000_led_off_pchlan(struct e1000_hw *hw);
...
static SInt32 e1000_check_for_copper_link_ich8lan(struct e1000_hw *hw);
static void e1000_lan_init_done_ich8lan(struct e1000_hw *hw);
static SInt32 e1000_sw_lcd_config_ich8lan(struct e1000_hw *hw);
...
void e1000_init_function_pointers_ich8lan(struct e1000_hw *hw)
{
	...
	switch (hw->mac.type) {
		...
		case e1000_pchlan:
			...
			break;
		default:
			e_debug("warning: no mac.type set so no init_phy_params done");
			break;
	}
}
 ...
 **/
SInt32 e1000_configure_k1_ich8lan(struct e1000_hw *hw, bool k1_enable)
{
	SInt32 ret_val = E1000_SUCCESS;
	UInt32 ctrl_reg = 0;
	UInt32 ctrl_ext = 0;
 ...
 **/
SInt32 e1000_oem_bits_config_ich8lan(struct e1000_hw *hw, bool d0_state)
{
	SInt32 ret_val = 0;
	UInt32 mac_reg;
	UInt16 oem_reg;
 ...
 **/
static SInt32 e1000_hv_phy_workarounds_ich8lan(struct e1000_hw *hw)
{
	SInt32 ret_val = E1000_SUCCESS;
...
static void e1000_lan_init_done_ich8lan(struct e1000_hw *hw)
{
	UInt32 data, loop = E1000_ICH8_LAN_INIT_TIMEOUT;
 ...
 *  PHY setup routines.
 **/
static SInt32 e1000_set_d0_lplu_state_ich8lan(struct e1000_hw *hw, bool active)
{
	struct e1000_phy_info *phy = &hw->phy;
	UInt32 phy_ctrl;
	SInt32 ret_val = E1000_SUCCESS;
 ...
 *  PHY setup routines.
 **/
static SInt32 e1000_set_d3_lplu_state_ich8lan(struct e1000_hw *hw, bool active)
{
	struct e1000_phy_info *phy = &hw->phy;
	UInt32 phy_ctrl;
	SInt32 ret_val = E1000_SUCCESS;
...
static SInt32 e1000_init_hw_ich8lan(struct e1000_hw *hw)
{
	...
	e_debug("starting e1000_init_hw_ich8lan");
