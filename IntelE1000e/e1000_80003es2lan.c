...
static SInt32  e1000_cfg_on_link_up_80003es2lan(struct e1000_hw *hw);
static SInt32  e1000_read_kmrn_reg_80003es2lan(struct e1000_hw *hw, UInt32 offset,
                                            UInt16 *data);
static SInt32  e1000_write_kmrn_reg_80003es2lan(struct e1000_hw *hw, UInt32 offset,
                                             UInt16 data);
 ...
 *
 **/
static SInt32 e1000_acquire_mac_csr_80003es2lan(struct e1000_hw *hw)
{
	UInt16 mask;
