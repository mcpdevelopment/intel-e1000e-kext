...
static UInt32 e1000_hash_mc_addr_generic(struct e1000_hw *hw, UInt8 *mc_addr);
static SInt32 e1000_set_default_fc_generic(struct e1000_hw *hw);
static SInt32 e1000_commit_fc_settings_generic(struct e1000_hw *hw);
static SInt32 e1000_poll_fiber_serdes_link_generic(struct e1000_hw *hw);
static SInt32 e1000_validate_mdi_setting_generic(struct e1000_hw *hw);
 ...
 **/
SInt32 e1000e_get_bus_info_pcie(struct e1000_hw *hw)
{
//	struct e1000_mac_info *mac = &hw->mac;
...
//	SInt32 ret_val;
	...
	e_debug("in e1000e_get_bus_info_pcie");
 ...
 **/
void e1000e_write_vfta_generic(struct e1000_hw *hw, UInt32 offset, UInt32 value)
{
 ...
 **/
void e1000e_init_rx_addrs(struct e1000_hw *hw, UInt16 rar_count)
{
	UInt32 i;
 ...
 *  in by addr.
 **/
void e1000e_rar_set(struct e1000_hw *hw, UInt8 *addr, UInt32 index)
{
 ...
 **/
SInt32 e1000e_check_for_copper_link(struct e1000_hw *hw)
{
	struct e1000_mac_info *mac = &hw->mac;
	SInt32 ret_val;
	bool link;
 ...
 **/
SInt32 e1000e_check_for_fiber_link(struct e1000_hw *hw)
{
	struct e1000_mac_info *mac = &hw->mac;
	UInt32 rxcw;
	UInt32 ctrl;
 ...
 *  a signal, then we need to force link up.
 **/
SInt32 e1000e_check_for_serdes_link(struct e1000_hw *hw)
{
	struct e1000_mac_info *mac = &hw->mac;
	UInt32 rxcw;
	UInt32 ctrl;
 ...
 **/
SInt32 e1000e_setup_link(struct e1000_hw *hw)
{
	SInt32 ret_val = E1000_SUCCESS;
 ...
 **/
SInt32 e1000e_setup_fiber_serdes_link(struct e1000_hw *hw)
{
	UInt32 ctrl;
	SInt32 ret_val = E1000_SUCCESS;
 ...
 **/
SInt32 e1000e_set_fc_watermarks(struct e1000_hw *hw)
{
	SInt32 ret_val = E1000_SUCCESS;
 ...
 **/
SInt32 e1000e_force_mac_fc(struct e1000_hw *hw)
{
	UInt32 ctrl;
	SInt32 ret_val = E1000_SUCCESS;
 ...
 *  partner.
 **/
SInt32 e1000e_config_fc_after_link_up(struct e1000_hw *hw)
{
	struct e1000_mac_info *mac = &hw->mac;
	SInt32 ret_val = E1000_SUCCESS;
 ...
 **/
SInt32 e1000e_get_speed_and_duplex_copper(struct e1000_hw *hw, UInt16 *speed,
									   UInt16 *duplex)
{
	UInt32 status;
 ...
 **/
SInt32 e1000e_get_speed_and_duplex_fiber_serdes(struct e1000_hw *hw,
 ...
 **/
SInt32 e1000e_get_hw_semaphore(struct e1000_hw *hw)
{
	UInt32 swsm;
	SInt32 ret_val = E1000_SUCCESS;
 ...
 **/
SInt32 e1000e_get_auto_rd_done(struct e1000_hw *hw)
{
	SInt32 i = 0;
	SInt32 ret_val = E1000_SUCCESS;
 ...
 **/
SInt32 e1000e_valid_led_default(struct e1000_hw *hw, UInt16 *data)
{
	SInt32 ret_val;
 ...
 *
 **/
SInt32 e1000e_id_led_init(struct e1000_hw *hw)
{
	struct e1000_mac_info *mac = &hw->mac;
	SInt32 ret_val;
 ...
 **/
SInt32 e1000e_cleanup_led_generic(struct e1000_hw *hw)
{
	SInt32 ret_val = E1000_SUCCESS;
 ...
 **/
SInt32 e1000e_blink_led(struct e1000_hw *hw)
{
 ...
 *  Turn LED on.
 **/
SInt32 e1000e_led_on_generic(struct e1000_hw *hw)
{
	UInt32 ctrl;
 ...
 *  Turn LED off.
 **/
SInt32 e1000e_led_off_generic(struct e1000_hw *hw)
{
	UInt32 ctrl;
 ...
 **/
void e1000e_set_pcie_no_snoop(struct e1000_hw *hw, UInt32 no_snoop)
{
	UInt32 gcr;
 ...
 *  requests.
 **/
SInt32 e1000e_disable_pcie_master(struct e1000_hw *hw)
{
	UInt32 ctrl;
